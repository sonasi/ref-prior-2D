#ifndef PDFUNCTION2D_H
#define PDFUNCTION2D_H
//-------------------------------------------------------------
//
...
namespace rfp2d
{
  ...
  public:
    ...
    */
    virtual std::vector<double>& generate(double theta1, double theta2)=0;
	    
	/** The following pure virtual functions must be 
        overridden by derived classes. 
        See for example, MarginalizedPoissonGamma
    */
    virtual long double operator() (std::vector<double>& xdata, double theta1, double theta2)=0; 
